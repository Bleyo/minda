...
{
    public $directoryPath = 'App\View';
    public $namespace;

    public function boot()
    {
        Blade::componentNamespace($this->directoryPath, $this->namespace);
        $this->loadViewsFrom(realpath(app_path('/View/templates')), $this->namespace);
